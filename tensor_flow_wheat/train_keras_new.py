...
plt_path = os.path.join(os.path.dirname(__file__),'outputs','example_images.png')
...
model.save(plt_path_learning_curves+'model.keras')
...
plt.xlabel('epoch')
plt.savefig(plt_path_learning_curves+'/learning_curves.png')
...
checkpoint_path = plt_path_learning_curves+"/cp.ckpt"
...
model.save(plt_path_learning_curves+'fine_tuned.keras')
...
plt.title('Training and Validation Loss')
plt.xlabel('epoch')
plt.savefig(plt_path_learning_curves+'/learning_curves_fine_tuning.png')
...
for i in range(9):
  ...
  plt.axis("off")
plt.savefig(plt_path_learning_curves+'/predictions.png')