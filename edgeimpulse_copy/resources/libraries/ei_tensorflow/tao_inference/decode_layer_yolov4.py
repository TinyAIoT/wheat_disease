...
# From: https://github.com/NVIDIA/tao_tensorflow1_backend/blob/c7a3926ddddf3911842e057620bceb45bb5303cc/nvidia_tao_tf1/cv/yolo_v4/layers/decode_layer.py
...
class YOLOv4DecodeLayer(Layer):
    ...
    def call(self, x):
        ...
        return tf.concat([x_min, y_min, x_max, y_max, cls_score], -1)
