...
# From https://github.com/NVIDIA/tao_tensorflow1_backend/blob/c7a3926ddddf3911842e057620bceb45bb5303cc/nvidia_tao_tf1/cv/yolo_v4/layers/bbox_postprocessing_layer.py
...
class BBoxPostProcessingLayer(Layer):
    ...
    def __init__(self, grid_scale_xy=1.0, **kwargs):
        """Init function."""
