...
def dataset_match_by_near_centroids(
    ...
    # convert to ndarray and reshape back to original shape
    original_shape = -1, output_width_height, output_width_height
    y_true_labels = np.array(y_true_labels).reshape(original_shape)
    y_pred_labels = np.array(y_pred_labels).reshape(original_shape)
